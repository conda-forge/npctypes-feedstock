About npctypes-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/npctypes-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/jakirkham/npctypes
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5205&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/npctypes-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `npctypes` can be installed with `conda`:
...
```
mamba install npctypes
```

It is possible to list all of the versions of `npctypes` available on your platform with `conda`:
...
```
mamba search npctypes --channel conda-forge
```
...
mamba repoquery search npctypes --channel conda-forge

# List packages depending on `npctypes`:
mamba repoquery whoneeds npctypes --channel conda-forge

# List dependencies of `npctypes`:
mamba repoquery depends npctypes --channel conda-forge
```
